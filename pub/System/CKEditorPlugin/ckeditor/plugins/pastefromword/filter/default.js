		...
		getRules : function( editor )
		{
			...
			return {
				...
				elements :
				{
					...
					{
						/*Alex:
						 * Es müssen unbedingt folgende Attribute entfernt werden:
						 * Align, Style, 
						...
						*/
						...
						//element.setAttribute("class", "Rittal_Standard");
						element.attributes[ 'class' ] = "Rittal_Standard";
						element.addStyle( "width:90%" );
