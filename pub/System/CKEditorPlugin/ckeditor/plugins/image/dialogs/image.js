									...
									[
										{
											...
											onLoad : function()
											{
												this.nummer = document.getElementsByClassName("cke_dialog_body").length;
											},
											onShow : function()
											{
												//Alex: Verbessern - veralgemeinern
												dialog = this.getDialog()
												var el_id = dialog.getContentElement('info', 'txtUrl').getInputElement().getId();
												...
												var options = {
														...
														callback: function (obj) { 
															dialog.getContentElement('info', 'txtUrl').getInputElement().setValue( obj.id );
															//document.getElementById(el_id).value = obj.id; 
															dialog.getContentElement('info', 'txtUrl').onChange();
														return;
														}
												};
												//Alex: Verbessern
					...
					[
						{
							type : 'file',
							id : 'filepath',
							label : editor.lang.image.fileBrowser,
							style: 'height:40px',
							size : 38,
							onChange : function()
							{
						...
						},
						{
							type : 'text',
							id : 'filename',
							label : editor.lang.image.fileName || "Dateiname im Q.Wiki",
							style : 'width: 60%',
							size : 20,
							onFocus : function()
							{
